...
<div class="row">
	<div class="col-lg-8">
		<h1 class="mt-4">Manage Data Konsumen</h1><hr/>
		<?php
		if(isset($_GET['op'])){
			$op = $_GET['op'];
			if($op=="tambah"){
				...
				<form method="post" action="<?php echo basename(__FILE__, '.php');?>?op=save">
					...
					<input type="password" name="c" class="form-control" placeholder="Password" maxlength="72" style="width:100%" required/><br/><br/>
				...
				<form method="post" action="<?php echo basename(__FILE__, '.php');?>?op=update">
					...
					<label>Password</label><br/>
					<input type="password" name="c" class="form-control" placeholder="Password (Kosongi Jika Tidak Diubah)" maxlength="72" style="width:100%"/><br/><br/>
		...
		?>
		<b style="font-size:16pt;">Data Konsumen</b> <a href="<?php echo basename(__FILE__, '.php');?>?op=tambah" style="text-decoration:none;font-size:16pt;float:right;">Tambah Data Konsumen</a><br/><br/>
